...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (314054,315564,4189343,4111099,320416,319843,443962,4108234,4158911,45769461)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (314054,315564,4189343,4111099,320416,319843,443962,4108234,4158911,45769461)
  and c.invalid_reason is null

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (321107,313007,314457,313006)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (321107,313007,314457,313006)
  and c.invalid_reason is null
