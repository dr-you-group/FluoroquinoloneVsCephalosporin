...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4230961,4055484,4294683)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4230961,4055484,4294683)
  and c.invalid_reason is null

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (381445,373858,441669,438411,46273347,372479,376512,375404,36716566,4334734,45757798,432621,381552,4135964,434337,373766,375249)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (381445,373858,441669,438411,46273347,372479,376512,375404,36716566,4334734,45757798,432621,381552,4135964,434337,373766,375249)
  and c.invalid_reason is null
