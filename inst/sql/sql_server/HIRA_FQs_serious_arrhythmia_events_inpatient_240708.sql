...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (321042,4120088,4171902,441139,4317150,4185572,4089462,4103295)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (321042,4120088,4171902,441139,4317150,4185572,4089462,4103295)
  and c.invalid_reason is null
