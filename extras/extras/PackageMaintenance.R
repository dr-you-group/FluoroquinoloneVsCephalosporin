...
OhdsiRTools::checkUsagePackage("FluoroquinoloneVsCephalosporin")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/FluoroquinoloneVsCephalosporin.pdf")
shell("R CMD Rd2pdf ./ --output=extras/FluoroquinoloneVsCephalosporin.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "FluoroquinoloneVsCephalosporin")
...
OhdsiRTools::createRenvLockFile("FluoroquinoloneVsCephalosporin")
