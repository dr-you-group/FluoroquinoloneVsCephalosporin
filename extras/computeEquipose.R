outputFolder <- ""  ## need to define
databaseName <- ""  ## need to define 
...
results$databaseId <- databaseName 

write.csv(results, file.path(outputFolder, "export", "psResults.csv"), row.names = F)